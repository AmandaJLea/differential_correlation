...
plot(results$cor_healthy - results$cor_sick,-log10(results$p_value),bty='n',col=as.factor(results$qvalue<0.05),xlab='difference in correlation (healthy-sick)',ylab='-log10, p-value')
